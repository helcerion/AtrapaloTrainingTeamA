 ...
 * Class PieceITest
 */
class PieceITest extends \PHPUnit_Framework_TestCase
{
    /** @var  PieceI */
    private $sut;
    ...
    public function itShouldGetBottomLinePosition()
    {
        ...
        $this->assertCount(1, $bottomLinePositions);
    }
    ...
    public function itShouldGetBottomLinePositionWhenRotatePiece()
    {
        ...
        $this->assertCount(4, $bottomLinePositions);
    }
    ...
    {
        $this->sut = new PieceI($this->boundingBoxMock, $this->pointBuilderMock);
    }

    private function rotate($rotateNum, $point2X, $point2Y, $point3X, $point3Y, $point4X, $point4Y)
    {
        $index = $rotateNum * 5;
