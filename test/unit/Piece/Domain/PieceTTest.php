 ...
 * Class PieceTTest
 */
class PieceTTest extends \PHPUnit_Framework_TestCase
{
    /** @var  PieceT */
    private $sut;
    ...
    {
        $this->sut = new PieceT($this->boundingBoxMock, $this->pointBuilderMock);
    }
