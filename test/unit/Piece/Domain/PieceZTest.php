 ...
 * Class PieceZTest
 */
class PieceZTest extends \PHPUnit_Framework_TestCase
{
    /** @var  PieceZ */
    private $sut;
    ...
    {
        $this->sut = new PieceZ($this->boundingBoxMock, $this->pointBuilderMock);
    }
