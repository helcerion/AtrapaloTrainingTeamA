 ...
 * Class PieceLTest
 */
class PieceLTest extends \PHPUnit_Framework_TestCase
{
    /** @var  PieceL */
    private $sut;
    ...
    {
        $this->sut = new PieceL($this->boundingBoxMock, $this->pointBuilderMock);
    }
